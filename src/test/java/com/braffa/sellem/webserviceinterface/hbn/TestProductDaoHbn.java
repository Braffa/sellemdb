...
public class TestProductDaoHbn {
	...
	public void testCreate() {
		try {
			...
			ProductDaoHbn productDaoHbn = new ProductDaoHbn (productMsg);
			productMsg = (ProductMsgXml) productDaoHbn.create();
	...
	public void testDelete() {
		try {
			...
			ProductDaoHbn productDaoHbn = new ProductDaoHbn (productMsg);
			productMsg = (ProductMsgXml) productDaoHbn.delete();
			System.out.println(productMsg.getSuccess());
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void testCount() {
		try {
			...
			ProductMsgXml productMsg = new ProductMsgXml(productXml);
			ProductDaoHbn productDaoHbn = new ProductDaoHbn (productMsg);
			productDaoHbn.getCount();
			System.out.println(productDaoHbn.getCount());
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void testRead() {
		try {
			...
			ProductMsgXml productMsg = new ProductMsgXml(productXml);
			ProductDaoHbn productDaoHbn = new ProductDaoHbn (productMsg);
			productMsg = (ProductMsgXml)productDaoHbn.read();
			System.out.println(productMsg.getSuccess());
	...
	public void testReadAll() {
		try {
			...
			ProductMsgXml productMsg = new ProductMsgXml(productXml);
			ProductDaoHbn productDaoHbn = new ProductDaoHbn (productMsg);
			productMsg = (ProductMsgXml)productDaoHbn.readAll();
			System.out.println(productMsg.getSuccess());
			ArrayList<ProductXml> lOfProducts = productMsg.getLOfProducts();
	...
	public void testReadByListOfKeys() {
		try {
			...
			ProductDaoHbn productDaoHbn = new ProductDaoHbn (productMsg);
			productMsg = (ProductMsgXml)productDaoHbn.readListOfKeys();
			System.out.println(productMsg.getSuccess());
	...
	public void testSearchByAuthor() {
		try {
			setUpProducts();
			ProductXml productXml = new ProductXml(); 
			productXml.setAuthor("JUSTIN");
			ProductMsgXml productMsg = new ProductMsgXml(productXml);
			productMsg.setSearchField("author");
			ProductDaoHbn productDaoHbn = new ProductDaoHbn (productMsg);
			productMsg = (ProductMsgXml)productDaoHbn.search();
			System.out.println(productMsg.getSuccess());
			ArrayList<ProductXml> lOfProducts = productMsg.getLOfProducts();
			assertEquals("testReadByListOfKeys wrong number of rows returned ",
					1, lOfProducts.size());
			...
			System.out.println(productXml.toString());
			assertEquals("getProduct failed Incorrect author returned ",
					"Sandercoe Justin", productXml.getAuthor());
			assertEquals("getProduct failed Incorrect image URL returned ",
			...
			assertEquals("getProduct failed Incorrect image large URL returned ",
					...
					productXml.getImageLargeURL());
			assertEquals("getProduct failed Incorrect manufacturer returned ",
					"Music Sales", productXml.getManufacturer());
			assertEquals("getProduct failed Incorrect product index returned ",
					"1", productXml.getProductIndex());
			assertEquals("getProduct failed Incorrect product group returned ",
					"Book", productXml.getProductgroup());
			assertEquals("getProduct failed Incorrect product id returned ",
					"9781849386685", productXml.getProductId());
			assertEquals("getProduct failed Incorrect product type returned ",
					"EAN", productXml.getProductidtype());
			assertEquals("getProduct failed Incorrect source returned ", "Amazon",
					productXml.getSource());
			assertEquals("actualProduct failed Incorrect source id returned ",
					"1849386684", productXml.getSourceid());
			assertEquals(
					"getProduct failed Incorrect title returned ",
	...
	public void testSearchByTitle() {
		try {
			setUpProducts();
			ProductXml productXml = new ProductXml(); 
			productXml.setTitle("Justinguitar.Com");
			ProductMsgXml productMsg = new ProductMsgXml(productXml);
			productMsg.setSearchField("title");
			ProductDaoHbn productDaoHbn = new ProductDaoHbn (productMsg);
			productMsg = (ProductMsgXml)productDaoHbn.search();
			System.out.println(productMsg.getSuccess());
			ArrayList<ProductXml> lOfProducts = productMsg.getLOfProducts();
	...
	public void testSearchByProductId() {
		try {
			setUpProducts();
			ProductXml productXml = new ProductXml(); 
			productXml.setProductId("9781849386685");
			ProductMsgXml productMsg = new ProductMsgXml(productXml);
			productMsg.setSearchField("productid");
			ProductDaoHbn productDaoHbn = new ProductDaoHbn (productMsg);
			productMsg = (ProductMsgXml)productDaoHbn.search();
			System.out.println(productMsg.getSuccess());
			ArrayList<ProductXml> lOfProducts = productMsg.getLOfProducts();
	...
	public void testSearchByManufacturer() {
		try {
			setUpProducts();
			ProductXml productXml = new ProductXml(); 
			productXml.setManufacturer("Music Sales");
			ProductMsgXml productMsg = new ProductMsgXml(productXml);
			productMsg.setSearchField("manufacturer");
			ProductDaoHbn productDaoHbn = new ProductDaoHbn (productMsg);
			productMsg = (ProductMsgXml)productDaoHbn.search();
			System.out.println(productMsg.getSuccess());
			ArrayList<ProductXml> lOfProducts = productMsg.getLOfProducts();
	...
	public void testUpdateAuthor() {
		try {
			...
			ProductMsgXml productMsg = new ProductMsgXml(productXml);
			ProductDaoHbn productDaoHbn = new ProductDaoHbn (productMsg);
			productMsg = (ProductMsgXml)productDaoHbn.update();
			System.out.println(productMsg.getSuccess());
