...
public class TestUserToProductDaoSql {
	...
	public void testCreate() {
		try {
			...
			UserToProductDaoSql UserToProductDaoSql = new UserToProductDaoSql(userToProductMsg);
			userToProductMsg = (UserToProductMsgXml) UserToProductDaoSql.create();
	...
	public void testDelete() {
		try {
			...
			UserToProductMsgXml userToProductMsg = new UserToProductMsgXml(userToProductXml);
			UserToProductDaoSql UserToProductDaoSql = new UserToProductDaoSql(userToProductMsg);
			userToProductMsg = (UserToProductMsgXml) UserToProductDaoSql.delete();
	...
	public void testCount() {
		try {
			...
			UserToProductMsgXml userToProductMsg = new UserToProductMsgXml(userToProductXml);
			UserToProductDaoSql UserToProductDaoSql = new UserToProductDaoSql(userToProductMsg);
			int count = UserToProductDaoSql.getCount();
	...
	public void testReadByProducIdProductIndexUserId() {
		try {
			...
			UserToProductMsgXml userToProductMsg = new UserToProductMsgXml(userToProductXml);
			UserToProductDaoSql UserToProductDaoSql = new UserToProductDaoSql(userToProductMsg);
			userToProductMsg = (UserToProductMsgXml) UserToProductDaoSql.read();
	...
	public void testReadByProductId() {
		try {
			...
			userToProductMsg = (UserToProductMsgXml) UserToProductDaoSql.read();
			ArrayList<UserToProductXml> lOfUserToProduct = userToProductMsg.getLOfUserToProduct();
			assertEquals("read failed 2 rowS  should be returned ", 2, lOfUserToProduct.size());
			userToProductXml = lOfUserToProduct.get(0);
