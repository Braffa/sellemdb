...
@XmlType(propOrder = {"author", "imageURL", "imageLargeURL", "manufacturer", "productIndex", "productgroup" ,
		"productId", "productidtype", "source", "sourceid", "title", "crDate", "updDate"})
public class ProductXml implements Serializable {
	...
	public ProductXml (String productId) {
	...
	public static class ProductBuilder {
		...
		public ProductXml build() {
			return new ProductXml(this);
		}
	}
	
	private ProductXml(ProductBuilder productBuilder) {
		...
		this.crDate = productBuilder.crDate;
		this.updDate = productBuilder.updDate;
	}
	
	public ProductXml(ProductHbn productHbn) {
		this.author = productHbn.getAuthor();
		this.imageURL = productHbn.getImageURL();
		this.imageLargeURL = productHbn.getImageLargeURL();
		this.manufacturer = productHbn.getManufacturer();
		this.productIndex = productHbn.getProductIndex();
		this.productgroup = productHbn.getProductgroup();
		this.productId = productHbn.getProductId();
		this.productidtype = productHbn.getProductidtype();
		this.source = productHbn.getSource();
		this.sourceid = productHbn.getSourceid();
		this.title = productHbn.getTitle();
		this.crDate = productHbn.getCrDate();
		this.updDate = productHbn.getUpdDate();
	}
